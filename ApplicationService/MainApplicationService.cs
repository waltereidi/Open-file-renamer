...
public class MainApplicationService
{
    ...
    private List<IFileProcessor> Command(object op ,IOperationContract contract, INumberedSequence fm) => op switch
    {
        NumberedSequenceBefore e => fm.GetNumberedSequenceAfterPreview(contract.GetFiles(), e._Separator),
        NumberedSequenceAfter e => fm.GetNumberedSequenceBeforePreview(contract.GetFiles(), e._Separator),
